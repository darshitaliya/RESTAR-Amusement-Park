...
if (isset($_POST['add_room'])) {
    ...
    if (file_exists("upload/" . $_FILES["image"]["name"])) {
        ...
        if ($query_run) {
            ...
            move_uploaded_file($_FILES["image"]['tmp_name'], "./admin/assets/images/gallery/" . $_FILES["image"]["name"]);
...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            ?>
            <a href="add_photo.php" class="add1">
                +
            </a>
          ...
          <div class='card'>
            <div class='card-body'>
              <h1 style='text-transform: uppercase; font-size: 35px;'>Added Gallery</h1>
                      ...
                      <th>
                        DELETE
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        $img = "images/gallery/$row[image]";
                                        echo "<tbody>
                          <tr>
                              <td>$row[id]</td>
                              <td><img src=$img style='width:100px !important;height: 100px !important;border-radius:0% !important' alt=$row[image]></td>
                              <td><a class='btn btn-inverse-success btn-sm' href='edit_gallery.php?id=$row[0]'><i class='mdi mdi-pencil-circle-outline mdi-24px'></i></td>
                              <td><a class='btn btn-inverse-danger btn-sm' href='delete_photo.php?id=$row[0]'><i class='mdi mdi-delete-empty mdi-24px'></td>
                            </tr>
                          </tbody>";
                                    }
                                    echo "</table>
              ...
              <div class='card'>
                <div class='row'>
                  <div class='card-body'>
                    <h1 style='text-align:center; text-shadow:-2px 2px 4px black;'>No Image Are Available Now!!!</h1>
                  </div>
                </div>
              </div>
            </div>";    
