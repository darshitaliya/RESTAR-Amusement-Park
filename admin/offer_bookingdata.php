          ...
          <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <li class="nav-item">
              <a class="nav-link" href="event_booking.php">
                ...
                <span class="menu-title">Event Booking Data</span>
              </a>
            </li>
            <li class="nav-item">
          ...
          <div class="main-panel">
            <div class="content-wrapper">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h1 style="text-transform: uppercase; font-size: 35px;">Offer booking INFORMATION</h1>
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        <thead>
                          ...
                          <?php
                          $select = "SELECT * FROM `offerbook` order by id desc";
