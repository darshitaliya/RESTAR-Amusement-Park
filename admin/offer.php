...
if (isset($_POST['add_offers'])) {
    ...
    if (file_exists("upload/" . $_FILES["image"]["name"])) {
        ...
        $query = "INSERT INTO `offer`(`toffer`,`Person`,`Price`,`offerprice`,`start_date`,`end_date`,`image`) 
              VALUES('$room_type','$max_person','$price','$oprice','$start_date','$end_date','$room_image')";
        ...
        if ($query_run) {
            ...
            move_uploaded_file($_FILES["image"]['tmp_name'], "./admin/images/offers/" . $_FILES["image"]["name"]);
            $_SESSION['success'] = "Offer added successfully.";
            header('Location: add_offers.php');
        } else {
            $_SESSION['status'] = "Failed to add Offer.";
            header('Location: add_offers.php');
        }
        exit();  // Exit after header redirection
    }
...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            ?>
            <a href="add_offers.php" class="add1">
                +
            </a>
          ...
          <div class='card'>
            <div class='card-body'>
              <h1 style='text-transform: uppercase; font-size: 35px;'>Added Offers</h1>
                      ...
                      <th>
                        DELETE
                          ...
                          <tr>
                              ...
                              <td><a class='btn btn-inverse-success btn-sm' href='edit_offer.php?id=$row[0]'><i class='mdi mdi-pencil-circle-outline mdi-24px'></i></td>
                              <td><a class='btn btn-inverse-danger btn-sm' href='delete_offer.php?id=$row[0]'><i class='mdi mdi-delete-empty mdi-24px'></td>
                            </tr>
                          </tbody>";
                                    }
                                    echo "</table>
