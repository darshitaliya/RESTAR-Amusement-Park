...
if (isset($_POST['add_event'])) {
  ...
  // Server-side validation for event price
  if ($event_price < 0) {
    $_SESSION['status'] = "Event Price cannot be negative.";
...
<body>
  ...
  <form method="post" name="room" onsubmit="return validtion()" action="" enctype="multipart/form-data">
    ...
    <div class="row">
            ...
            <div class="col-md-6">
  <div class="form-group">
    <label for="size">Event Price:</label>
    <input type="number" class="form-control" id="event_price" name="event_price" min="0">
  ...
  function validtion() {
    ...
    let room1 = document.forms["room"]["event_name"].value;
    let room2 = document.forms["room"]["start_date"].value;
    let room3 = document.forms["room"]["end_date"].value;
    let room4 = document.forms["room"]["event_price"].value;
    let room5 = document.forms["room"]["info"].value;

    if (room1 == "") {
        document.getElementById("room1").innerHTML = "Event name is required";
        valid = false;
    }
    if (room2 == "") {
        document.getElementById("room2").innerHTML = "Start date is required";
        valid = false;
    }
    if (room3 == "") {
        document.getElementById("room3").innerHTML = "End date is required";
        valid = false;
    }
    if (room4 == "") {
        document.getElementById("room4").innerHTML = "Event Price is required";
        valid = false;
    } else if (parseFloat(room4) < 0) {
        document.getElementById("room4").innerHTML = "Event Price cannot be negative";
        valid = false;
    }
    if (room5 == "") {
        document.getElementById("room5").innerHTML = "Information is required";
        valid = false;
    }
