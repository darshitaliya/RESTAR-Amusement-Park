...
if (isset ($_POST['delete2'])) {
  ...
  $deleteQuery = "DELETE FROM `cardoffer` WHERE `id` = $idToDelete";
...
$select = "SELECT * FROM `cardoffer` order by `id` desc";
if ($search) {
  $select = "SELECT * From `cardoffer` where cardno like '%$search%' or cardname like '%$search%' or cardemail like '%$search%'";
}
    ...
    <body>
      <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
          ...
          <div class="main-panel">
            <div class="content-wrapper">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h1 style="text-transform: uppercase; font-size: 35px;">Offer Payment Data</h1>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php
                                      ...
                                      $hidden_part = str_repeat('*', strlen($card_number) - 4);
                                      echo substr($card_number, 0, 4) . ' ' . chunk_split($hidden_part, 4, ' ');
                                    ?>
          </td>
          ...
          <td>
            <a href="cardview4.php?id=<?php echo $row['id']; ?>&cardno=<?php echo $row['cardno']; ?>&cardname=<?php echo $row['cardname']; ?>&cardemail=<?php echo $row['cardemail']; ?>&cardmonth=<?php echo $row['cardmonth']; ?>&cardyear=<?php echo $row['cardyear']; ?>&cvv=<?php echo $row['cvv']; ?>"
              ...
              <input type="hidden" name="delete2" value="<?php echo $row['id']; ?>">
