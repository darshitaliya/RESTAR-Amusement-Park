...
// Construct the query
$q = "SELECT * FROM gallery WHERE id=$eid";
...
if (isset ($_REQUEST['add_room'])) {
    ...
    $q = "update gallery set image='$img_name' where id=$eid";
    echo $q;
...
<body>
  ...
  <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="hero">
                                <label for="input-file" id='drop-area'>
                                    ...
                                    <div id="img-view"
                                        style="background-image:url('<?php echo "assets/images/gallery/$r[7]"; ?>')"></div>
                                </label>
                            </div>
                        </div>
                    </div>
    <div class="row">
      <div class="col-md-12">
        <button type="submit" class="btn btn-primary" name="add_room">Edit Gallery</button>
      </div>
    </div>
  </form>
