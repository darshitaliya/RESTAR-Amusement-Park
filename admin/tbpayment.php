...
$select = "SELECT * FROM `cardticket` order by `cardid` desc";
if ($search) {
  $select = "SELECT * From `cardticket` where cardno like '%$search%' or cardname like '%$search%' or cardemail like '%$search%'";
}
