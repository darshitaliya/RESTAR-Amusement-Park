          ...
          <div class="main-panel">
            <div class="content-wrapper">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h1 style="text-transform: uppercase; font-size: 35px;">daining booking information</h1>
                    ...
                    <tbody>
                        <?php
                        // Fetch dining reservation data from the database
                        $query = "SELECT * FROM daining1 order by id desc";
