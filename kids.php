...
<div class="boxed_wrapper">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/32.png" class="card-img-top" alt="Shirt 1">
                    <div class="card-body">
                        <h5 class="card-title">Unisex UPF40+UV N9 Swimsuit set</h5>
                        <p class="card-price"><strong>Price: ₹250</strong></p>
                        <p class="card-text">Size: S, M, L & More</p>
                        <button class="btn-buy" onclick="window.location.href='checkout.php?item_id=1&item_name=Barmuda-Unisex&price=250'">Buy Now</button>
                        <button class="btn-add-to-cart" onclick="addToCart(1, 'Unisex UPF40+UV N9 Swimsuit set', 250)">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/44.jpg" class="card-img-top" alt="Shirt 2">
                    <div class="card-body">
                        <h5 class="card-title">Girl Zipper Swimwear Set</h5>
                        <p class="card-price"><strong>Price: ₹350</strong></p>
                        <p class="card-text">Size: M, L, XL & More</p>
                        <button class="btn-buy" onclick="window.location.href='checkout.php?item_id=2&item_name=T-Shirt-Unisex&price=350'">Buy Now</button>
                        <button class="btn-add-to-cart" onclick="addToCart(2, 'Girl Zipper Swimwear Set', 350)">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/45.jpg" class="card-img-top" alt="Hoodie 1">
                    <div class="card-body">
                        <h5 class="card-title">Swim Shoot Combo-Unisex</h5>
                        <p class="card-price"><strong>Price: ₹350</strong></p>
                        <p class="card-text">Size: M, L, XL & More</p>
                        <button class="btn-buy" onclick="window.location.href='checkout.php?item_id=3&item_name=T-Shirt+Bermuda+Combo-Unisex&price=350'">Buy Now</button>
                        <button class="btn-add-to-cart" onclick="addToCart(3, 'Swim Shoot Combo-Unisex', 350)">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/48.jpg" class="card-img-top" alt="Cap 1">
                    <div class="card-body">
                        <h5 class="card-title">Speedo-Unisex</h5>
                        <p class="card-price"><strong>Price: ₹350</strong></p>
                        <p class="card-text">Size: S, M, L & More</p>
                        <button class="btn-buy" onclick="window.location.href='checkout.php?item_id=4&item_name=T-Shirt-Unisex&price=350'">Buy Now</button>
                        <button class="btn-add-to-cart" onclick="addToCart(4, 'Speedo-Unisex', 350)">Add to Cart</button>
                    </div>
                </div>
            </div>
