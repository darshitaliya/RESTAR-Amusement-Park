...
$query = "SELECT id, room_type, price FROM rooms";
...
if (isset($_POST['add'])) {
    ...
    $insert = "INSERT INTO `room`(`fname`, `lname`, `email`, `birthdate`, `city`, `phone`, `room`, `nroom`, `totalprice`, `checkin`, `checkout`,`amount`) VALUES ('$fname', '$lname', '$email', '$birthdate', '$city', '$phone', '$room', '$nroom', '$totalprice', '$checkin', '$checkout','$amount')";
                            ...
                            <form method="post" action="" id="booking-form" class="default-form" novalidate="novalidate" onsubmit="return validateForm()">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        ...
                                        <input type="text" class="form-control text-font" name="totalprice" id="totalPrice" value="" readonly>
                                    </div>
