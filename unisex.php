...
<div class="boxed_wrapper">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/7.webp" class="card-img-top" alt="Shirt 1">
                    <div class="card-body">
                        <h5 class="card-title">Barmuda-Unisex</h5>
                        ...
                        <button class="btn-add-to-cart" onclick="addToCart(1, 'Barmuda-Unisex', 250)">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/8.webp" class="card-img-top" alt="Shirt 2">
                    <div class="card-body">
                        <h5 class="card-title">T-Shirt-Unisex</h5>
                        ...
                        <button class="btn-add-to-cart" onclick="addToCart(2, 'T-Shirt-Unisex', 350)">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/9.webp" class="card-img-top" alt="Hoodie 1">
                    <div class="card-body">
                        <h5 class="card-title">T-Shirt + Bermuda Combo-Unisex</h5>
                        <p class="card-price"><strong>Price: ₹350</strong></p>
                        <p class="card-text">Size: M, L, XL & More</p>
                        ...
                        <button class="btn-add-to-cart" onclick="addToCart(3, 'T-Shirt + Bermuda Combo-Unisex', 350)">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="admin/images/cloths/10.webp" class="card-img-top" alt="Cap 1">
                    <div class="card-body">
                        <h5 class="card-title">T-Shirt-Unisex</h5>
                        <p class="card-price"><strong>Price: ₹350</strong></p>
                        <p class="card-text">Size: S, M, L & More</p>
                        ...
                        <button class="btn-add-to-cart" onclick="addToCart(4, 'T-Shirt-Unisex', 350)">Add to Cart</button>
                    </div>
                </div>
            </div>
