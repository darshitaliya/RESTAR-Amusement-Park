...
if (isset($_POST['pay'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO `cardcloths`(`cardno`, `cardname`, `cardemail`, `cardmonth`, `cardyear`, `cvv`) VALUES (?, ?, ?, ?, ?, ?)");
    ...
    if ($result) {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = "Congrats $fname Your Order Booked Successfully";
            ...
            <div
                ...
                <h1
                    ...
                    <button
                        style="padding: 12px 24px; background-color: #f2645a; color: #fff; border: none; border-radius: 5px; font-size: 20px;">
                        YOUR ORDER CONFIROM SUCCESSFULLY THANK YOU FOR ORDER </button>
                </div>
